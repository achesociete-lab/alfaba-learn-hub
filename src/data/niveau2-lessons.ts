    ...
    grammar: [
      {
        ...
        examples: [
          { arabic: "لُغَةٌ", transliteration: "lughatun", meaning: "langue" },
          { arabic: "عَرَبِيٌّ", transliteration: "'arabiyyun", meaning: "arabe" },
          { arabic: "جَمِيلٌ", transliteration: "jamîlun", meaning: "beau" },
          { arabic: "كَلَامٌ", transliteration: "kalâmun", meaning: "parole" },
          { arabic: "حَرْفٌ", transliteration: "harfun", meaning: "lettre" },
          { arabic: "لِسَانٌ", transliteration: "lisânun", meaning: "langue (organe)" },
