...
const lesson1: Lesson = {
  ...
  theory: [
    ...
    },
    {
      ...
      letterGrid: [
        ...
        { letter: "ث", name: "Thâ'", sound: "son entre les dents (souffle)" },
        { letter: "ج", name: "Jîm", sound: "j comme 'jardin'" },
        { letter: "ح", name: "Hâ'", sound: "h guttural (souffle profond)" },
        { letter: "خ", name: "Khâ'", sound: "kh (raclement de gorge)" },
        { letter: "د", name: "Dâl", sound: "d comme 'dent'" },
        { letter: "ذ", name: "Dhâl", sound: "son entre les dents (vibré)" },
        ...
        { letter: "غ", name: "Ghayn", sound: "r grasseyé du fond de la gorge" },
  ...
  qcm: [
    ...
    { question: "Comment se prononce la lettre خ ?", options: ["Comme un 'k'", "Comme la raclement de gorge", "Comme un 'h' léger", "Comme un 'g'"], correctIndex: 1, explanation: "Le Khâ' (خ) se prononce comme la raclement de gorge ou le 'ch' allemand dans 'Bach'." },
...
const lesson5: Lesson = {
  ...
  theory: [
    ...
    },
    {
      ...
      arabicExamples: [
        { arabic: "نُورٌ", transliteration: "nûrun", meaning: "lumière" },
        { arabic: "سُورٌ", transliteration: "sûrun", meaning: "mur / rempart" },
        { arabic: "يَقُول", transliteration: "yaqûl", meaning: "il dit" },
        { arabic: "رَسُولٌ", transliteration: "rasûlun", meaning: "messager" },
        { arabic: "دُرُوسٌ", transliteration: "durûsun", meaning: "leçons" },
      ],
    },
    {
      ...
      arabicExamples: [
        ...
        { arabic: "صَغِيرٌ", transliteration: "ṣaghîrun", meaning: "petit" },
        { arabic: "جَمِيلٌ", transliteration: "jamîlun", meaning: "beau" },
        { arabic: "طَرِيقٌ", transliteration: "ṭarîqun", meaning: "chemin" },
        { arabic: "سَعِيدٌ", transliteration: "sa'îdun", meaning: "heureux" },
      ],
    },
  ],
  qcm: [
    ...
    { question: "Quel mot contient un û long ?", options: ["بَابٌ", "كَبِيرٌ", "رَسُولٌ", "قَلَمٌ"], correctIndex: 2, explanation: "رَسُولٌ contient un û long (Sîn + damma + Wâw)." },
  ...
  dictation: [
    { word: "بَابٌ", transliteration: "bâbun (porte)", options: ["بَبْ", "بَابٌ", "بُوب", "بِيب"], correctIndex: 1 },
    { word: "نُورٌ", transliteration: "nûrun (lumière)", options: ["نَار", "نِير", "نُورٌ", "نَوْر"], correctIndex: 2 },
    { word: "كَبِيرٌ", transliteration: "kabîrun (grand)", options: ["كَبَر", "كَبُور", "كَبِيرٌ", "كُبُر"], correctIndex: 2 },
...
const lesson6: Lesson = {
  ...
  theory: [
    ...
    },
    {
      ...
      arabicExamples: [
        { arabic: "أَبٌ", transliteration: "abun", meaning: "père" },
        { arabic: "أُمٌّ", transliteration: "ummun", meaning: "mère" },
        { arabic: "أَخٌ", transliteration: "akhun", meaning: "frère" },
        { arabic: "بَابٌ", transliteration: "bâbun", meaning: "porte" },
        { arabic: "دَمٌ", transliteration: "damun", meaning: "sang" },
        { arabic: "يَدٌ", transliteration: "yadun", meaning: "main" },
        { arabic: "حُبٌّ", transliteration: "ḥubbun", meaning: "amour" },
        { arabic: "قَلْبٌ", transliteration: "qalbun", meaning: "cœur" },
      ],
    },
    {
      ...
      arabicExamples: [
        { arabic: "كِتَابٌ", transliteration: "kitâbun", meaning: "livre" },
        { arabic: "قَلَمٌ", transliteration: "qalamun", meaning: "stylo" },
        { arabic: "بَيْتٌ", transliteration: "baytun", meaning: "maison" },
        { arabic: "مَاءٌ", transliteration: "mâ'un", meaning: "eau" },
        { arabic: "خُبْزٌ", transliteration: "khubzun", meaning: "pain" },
        { arabic: "شَمْسٌ", transliteration: "shamsun", meaning: "soleil" },
        { arabic: "قَمَرٌ", transliteration: "qamarun", meaning: "lune" },
        { arabic: "وَلَدٌ", transliteration: "waladun", meaning: "garçon" },
        { arabic: "بِنْتٌ", transliteration: "bintun", meaning: "fille" },
        { arabic: "رَجُلٌ", transliteration: "rajulun", meaning: "homme" },
      ],
    },
    {
      title: "Les couleurs",
      ...
      arabicExamples: [
        { arabic: "أَبْيَضٌ", transliteration: "abyaḍun", meaning: "blanc" },
        { arabic: "أَسْوَدٌ", transliteration: "aswadun", meaning: "noir" },
        { arabic: "أَحْمَرٌ", transliteration: "aḥmarun", meaning: "rouge" },
        { arabic: "أَخْضَرٌ", transliteration: "akhḍarun", meaning: "vert" },
        { arabic: "أَزْرَقٌ", transliteration: "azraqun", meaning: "bleu" },
      ],
  ...
  dictation: [
    { word: "أَبٌ", transliteration: "abun (père)", options: ["أَبٌ", "إِبٌ", "أُبٌ", "آبٌ"], correctIndex: 0 },
    { word: "كِتَابٌ", transliteration: "kitâbun (livre)", options: ["كُتُبٌ", "كِتَابٌ", "كَتَبَ", "كَاتِبٌ"], correctIndex: 1 },
    { word: "بَيْتٌ", transliteration: "baytun (maison)", options: ["بَيْتٌ", "بَاتَ", "بِنْتٌ", "بُيُوتٌ"], correctIndex: 0 },
    { word: "شَمْسٌ", transliteration: "shamsun (soleil)", options: ["شَمْسٌ", "قَمَرٌ", "شَمَسَ", "شُمُسٌ"], correctIndex: 0 },
    { word: "مَاءٌ", transliteration: "mâ'un (eau)", options: ["مَعَ", "مَاءٌ", "مَا", "مُوءٌ"], correctIndex: 1 },
    { word: "جَمَلٌ", transliteration: "jamalun (chameau)", options: ["جَمَلٌ", "جِمَالٌ", "جَمِيلٌ", "جَمَّلَ"], correctIndex: 0 },
    { word: "وَلَدٌ", transliteration: "waladun (garçon)", options: ["وَلَدٌ", "وَالِدٌ", "وِلَادَةٌ", "أَوْلَادٌ"], correctIndex: 0 },
    { word: "قَلَمٌ", transliteration: "qalamun (stylo)", options: ["كَلَمٌ", "قَلَمٌ", "قَلِمَ", "قُلُمٌ"], correctIndex: 1 },
    { word: "بِنْتٌ", transliteration: "bintun (fille)", options: ["بَنَتَ", "بِنْتٌ", "بَيْتٌ", "بُنُتٌ"], correctIndex: 1 },
    { word: "رَجُلٌ", transliteration: "rajulun (homme)", options: ["رَجُلٌ", "رِجَالٌ", "رَجَلَ", "رُجُلٌ"], correctIndex: 0 },
  ],
};
...
const lesson8: Lesson = {
  ...
  theory: [
    ...
    },
    {
      ...
      arabicExamples: [
        ...
        { arabic: "حُبٌّ", transliteration: "ḥubbun", meaning: "amour" },
        { arabic: "شَكٌّ", transliteration: "shakkun", meaning: "doute" },
      ],
    },
    {
      ...
      arabicExamples: [
        { arabic: "مُحَمَّدٌ", transliteration: "muḥammadun", meaning: "Muhammad (prénom)" },
  ...
  dictation: [
    { word: "أُمٌّ", transliteration: "ummun (mère)", options: ["أُمٌ", "أُمٌّ", "أَمٌ", "إِمٌّ"], correctIndex: 1 },
    { word: "حَقٌّ", transliteration: "ḥaqqun (vérité)", options: ["حَقٌ", "حَقٌّ", "خَقٌّ", "حَقَ"], correctIndex: 1 },
    { word: "رَبٌّ", transliteration: "rabbun (seigneur)", options: ["رَبٌ", "رَبٌّ", "رُبٌّ", "رَبَ"], correctIndex: 1 },
    { word: "عَلَّمَ", transliteration: "'allama (il a enseigné)", options: ["عَلَمَ", "عَلَّمَ", "عُلِّمَ", "عَالَمَ"], correctIndex: 1 },
    { word: "مُحَمَّدٌ", transliteration: "muḥammadun", options: ["مُحَمَدٌ", "مُحَمَّدٌ", "مَحْمَدٌ", "مُحَمِّدٌ"], correctIndex: 1 },
    { word: "حُبٌّ", transliteration: "ḥubbun (amour)", options: ["حُبٌ", "حُبٌّ", "حَبٌّ", "خُبٌّ"], correctIndex: 1 },
    ...
    { word: "كُلٌّ", transliteration: "kullun (tout)", options: ["كُلٌ", "كُلٌّ", "كَلٌّ", "كِلٌّ"], correctIndex: 1 },
    { word: "شَكٌّ", transliteration: "shakkun (doute)", options: ["شَكٌ", "شَكٌّ", "شِكٌّ", "صَكٌّ"], correctIndex: 1 },
  ],
};
...
const lesson10: Lesson = {
  ...
  dictation: [
    { word: "اللهُ أَكْبَرُ", transliteration: "Allâhou akbar (Allah est le plus Grand)", options: ["اللهُ أَكْبَرُ", "اللهُ أَحَدٌ", "أَكْبَرُ اللهُ", "اللهُ كَبِيرٌ"], correctIndex: 0 },
    { word: "بِسْمِ اللهِ", transliteration: "bismi-llâhi (au nom d'Allah)", options: ["بِسْمِ اللهِ", "بَاسْمِ اللهِ", "بِاسْمِ اللهِ", "بِسْمَ اللهِ"], correctIndex: 0 },
    ...
    { word: "هٰذَا بَيْتٌ كَبِيرٌ", transliteration: "hâdhâ baytoun kabîr (ceci est une grande maison)", options: ["هٰذَا بَيْتٌ صَغِيرٌ", "هٰذَا بَيْتٌ كَبِيرٌ", "هٰذِهِ بَيْتٌ كَبِيرٌ", "هٰذَا بَابٌ كَبِيرٌ"], correctIndex: 1 },
    ...
    { word: "قُلْ هُوَ اللهُ أَحَدٌ", transliteration: "qoul houwa-llâhou aḥad (Dis : Il est Allah, Unique)", options: ["قُلْ هُوَ اللهُ أَحَدٌ", "قَالَ هُوَ اللهُ أَحَدٌ", "قُلْ هُوَ اللهُ وَاحِدٌ", "قُلْ هُوَ اللهُ الأَحَدُ"], correctIndex: 0 },
    ...
    { word: "إِنَّ اللهَ غَفُورٌ رَحِيمٌ", transliteration: "inna-llâha ghafouroun raḥîm (certes Allah est Pardonnant, Miséricordieux)", options: ["إِنَّ اللهَ غَفُورٌ رَحِيمٌ", "اللهُ غَفُورٌ رَحِيمٌ", "إِنَّ اللهَ كَرِيمٌ رَحِيمٌ", "إِنَّ اللهَ غَفُورُ الرَّحِيمُ"], correctIndex: 0 },
  ...
  theory: [
    {
      ...
      arabicExamples: [
        { arabic: "أَبٌ", transliteration: "", meaning: "Père" },
        { arabic: "أُمٌّ", transliteration: "", meaning: "Mère" },
        { arabic: "أَخٌ", transliteration: "", meaning: "Frère" },
        { arabic: "أُخْتٌ", transliteration: "", meaning: "Sœur" },
        { arabic: "بَيْتٌ", transliteration: "", meaning: "Maison" },
      ],
    ...
    },
    {
      ...
      arabicExamples: [
        { arabic: "يَدٌ", transliteration: "", meaning: "Main" },
        { arabic: "رَأْسٌ", transliteration: "", meaning: "Tête" },
        { arabic: "عَيْنٌ", transliteration: "", meaning: "Œil" },
        { arabic: "أُذُنٌ", transliteration: "", meaning: "Oreille" },
        { arabic: "قَلْبٌ", transliteration: "", meaning: "Cœur" },
      ],
    ...
    },
    {
      ...
      arabicExamples: [
        { arabic: "شَمْسٌ", transliteration: "", meaning: "Soleil" },
        { arabic: "قَمَرٌ", transliteration: "", meaning: "Lune" },
        { arabic: "مَاءٌ", transliteration: "", meaning: "Eau" },
        { arabic: "نَارٌ", transliteration: "", meaning: "Feu" },
        { arabic: "سَمَاءٌ", transliteration: "", meaning: "Ciel" },
      ],
    ...
    },
    {
      ...
      arabicExamples: [
        { arabic: "كِتَابٌ", transliteration: "", meaning: "Livre" },
        { arabic: "قَلَمٌ", transliteration: "", meaning: "Stylo" },
        { arabic: "بَابٌ", transliteration: "", meaning: "Porte" },
        { arabic: "مَسْجِدٌ", transliteration: "", meaning: "Mosquée" },
        { arabic: "طَعَامٌ", transliteration: "", meaning: "Nourriture" },
      ],
