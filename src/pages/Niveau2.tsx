...
const lessons = [
  ...
  { num: 6,  title: "La phrase verbale", desc: "Le verbe au passé, accord en genre", icon: GraduationCap },
  { num: 14, title: "Le présent et le futur (المضارع)", desc: "Conjugaison du présent et futur proche", icon: GraduationCap },
  { num: 7,  title: "Compréhension de texte I", desc: "Mots interrogatifs et stratégies de lecture", icon: FileText },
  { num: 8,  title: "Les pronoms personnels", desc: "Pronoms détachés et attachés", icon: PenTool },
  { num: 15, title: "L'annexion nominale (الإضافة)", desc: "Relier deux noms pour exprimer la possession", icon: GraduationCap },
  { num: 9,  title: "Compréhension de texte II", desc: "Connecteurs logiques et adverbes de temps", icon: FileText },
  { num: 10, title: "Les prépositions", desc: "في، على، من، إلى et leur usage", icon: GraduationCap },
  { num: 16, title: "Les nombres, jours et mois", desc: "Compter en arabe et nommer les jours", icon: GraduationCap },
  { num: 17, title: "كان et la négation (لَيْس)", desc: "Le verbe être au passé et la négation au présent", icon: GraduationCap },
  { num: 11, title: "Consolidation", desc: "Révision de toutes les notions du niveau 2", icon: PenTool },
  { num: 12, title: "Évaluation finale", desc: "Évaluation complète du niveau 2", icon: PenTool },
  { num: 13, title: "اللغة العربية", desc: "La langue arabe et les lettres solaires/lunaires", icon: BookOpen },
];

const grammarTopics = [
  "La phrase nominale (الجملة الاسمية)",
  "La phrase verbale (الجملة الفعلية)",
  "Le présent et le futur (المضارع)",
  "Le masculin, féminin et pluriel",
  "Les pronoms personnels",
  "L'annexion nominale (الإضافة)",
  "Les prépositions (حروف الجر)",
  "Les nombres, jours et mois",
  "كان et لَيْس",
  "L'article défini (ال)",
];
