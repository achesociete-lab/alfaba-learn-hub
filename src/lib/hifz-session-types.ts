...
export const HIFZ_SESSION_TYPES: Array<{
...
}> = [
  {
    ...
    long: "Le nouveau hizb mémorisé depuis la dernière session, récité devant le professeur.",
  ...
  },
  {
    ...
    long: "Récitation d'un juz entier (2 hizb) sans interruption ni aide.",
    badgeBg: "bg-blue-100",
